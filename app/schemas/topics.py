...
class TopicsOverlayParams(BaseModel):
    ...
    coverage_min_pct: float = Field(default=35.0, ge=0.0, le=100.0)
    coverage_max_pct: float = Field(default=50.0, ge=0.0, le=100.0)
    words_min: int = Field(default=3, ge=1, le=50)
    words_max: int = Field(default=6, ge=1, le=50)
    min_font_size: int = Field(default=20, ge=6, le=200)
    base_font_size: int = Field(default=100, ge=20, le=400)
